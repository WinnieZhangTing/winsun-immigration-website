          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                bio: "With a Bachelor's degree in Communication Sciences and experience across Mexico and Canada, Denisse brings expertise in corporate communications, talent strategy, client engagement, and operations. Drawing on her professional background and personal success through the Manitoba Provincial Nominee Program, she delivers culturally responsive, personalized guidance to clients worldwide in both English and Spanish.",
                bioCn: 'Denisse 拥有传播科学学士学位及横跨墨西哥与加拿大的职业经验，专长涵盖企业品牌、人才战略、客户关系与运营管理。结合亲身成功通过曼省省提名项目的经历，她以英语和西班牙语为全球客户提供专业、精准且高度个性化的服务。',
                photo: '/dennis.jpg',
              },
              {
                name: 'Jing Zhang',
